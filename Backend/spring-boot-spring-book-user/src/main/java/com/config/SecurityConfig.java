     ...
     SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
         return http.csrf(csrf -> csrf.disable())
                 .authorizeHttpRequests(requests -> requests
                         ...
                         .requestMatchers("/api/books").hasRole("ADMIN") // Keep this for book creation/modification
                         .requestMatchers("/api/books/{id}", "/api/books/search/**").hasAnyRole("ADMIN", "USER") // Allow book retrieval for all
