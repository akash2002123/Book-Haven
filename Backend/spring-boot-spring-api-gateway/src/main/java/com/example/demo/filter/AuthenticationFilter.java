    ...
    private boolean isAuthorized(String role, String path, String method) {
        if ("ADMIN".equalsIgnoreCase(role)) {
            ...
            if (path.startsWith("/api/books")) {
                ...
                return method.equals("GET") && path.matches("/api/cart/\\d+") || method.equals("POST") && path.equals("/api/cart") || method.equals("DELETE") && path.matches("/api/cart/clear/\\d+") ||method.equals("POST") && path.equals("/api/cart") || method.equals("DELETE") && path.matches("/api/cart/\\d+");
